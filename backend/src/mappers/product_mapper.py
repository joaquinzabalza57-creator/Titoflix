...
# Los mappers concentran la conversion ORM -> DTO. Asi los servicios no repiten
# calculos de respuesta ni exponen objetos SQLAlchemy al router.
...
def to_contenido_response(contenido: Contenido) -> ContenidoResponseDTO:
    dto = ContenidoResponseDTO.model_validate(contenido)
...
def to_product_response(product: Contenido) -> ProductResponseDTO:
    """Alias historico de producto hacia contenido."""
