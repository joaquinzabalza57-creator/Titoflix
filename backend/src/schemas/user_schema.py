...
class CreateUserSchema(BaseModel):
    ...
    age: int = Field(ge=18)                     # Edad mínima requerida: 18 años o más


class UpdateUserSchema(BaseModel):
    email: EmailStr | None = None                 # Email opcional (solo se envía si se quiere actualizar)
    password: str | None = Field(default=None, min_length=8)  # Contraseña opcional (mínimo 8 caracteres)
    age: int | None = Field(default=None, ge=18)  # Edad opcional (si se envía, debe ser ≥ 18)
